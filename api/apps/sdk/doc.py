...
def register(dataset_id, tenant_id):
    ...
    try:
        # 调用文件服务注册文档
        doc = FileService.register_document(kb, req, tenant_id)
...
def update_doc(tenant_id, dataset_id, document_id):
    ...
    if "chunk_method" in req:
        valid_chunk_method = {"naive", "manual", "qa", "table", "paper", "book", "laws", "presentation", "picture", "one", "knowledge_graph", "email", "tag", "report"}
